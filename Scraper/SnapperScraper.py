...
class SnapperScraper:
    def __init__(self):
        ...
        self._sections_url = "https://partstreamstg.arinet.com/Parts/GetAssembly?cb=jsonp1721852459316&arib=SCG&aria={aria_id}&includeImgs=true&responsive=true&imgIsThmb=true&arik=8h2sNgozvKqOu5RFDt6H&aril=en-US&ariv=https%253A%252F%252Fwww.scagparts.com%252Fparts-lookup"
        self._parts_url = "https://partstreamstg.arinet.com/Parts/GetDetails?cb=jsonp1721854034134&ariq={ariq_slug}&responsive=true&arik=8h2sNgozvKqOu5RFDt6H&aril=en-US&ariv=https%253A%252F%252Fwww.scagparts.com%252Fparts-lookup"
        self._latest_model_code = 134410
